...
import edu.unict.oop.thread.LettoreAnzianiAndBambini;
...
public class Main {   
    ...
    public static void main(String[] args) {
        ...
        Thread lettoreAnzianiANDBambinoT4 = new Thread(new LettoreAnzianiAndBambini(archivio,"T4"));
       
        // Si Lanciano i Thread (l'ordine con cui far partire i thread non è importante)
        lettoreClientiT3.start();
        produttoreT1.start();
        consumatoreT2.start();
        lettoreAnzianiANDBambinoT4.start();
